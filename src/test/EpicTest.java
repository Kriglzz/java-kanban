...
class EpicTest {
    ...
    public void shouldReturnNewWhenAllSubtasksNew(){
        ...
        SubTask subTask1 = new SubTask("subtask1", "description1", 1, LocalDateTime.of(2023, 11, 3, 1, 1), 1);
        taskManager.addNewSubTask(subTask1);
        SubTask subTask2 = new SubTask("subtask2", "description2", 1, LocalDateTime.of(2023, 11, 4, 1, 1), 1);
    ...
    public void shouldReturnDoneWhenAllSubtasksDone(){
        ...
        epic.setId(1);
        taskManager.addNewEpicTask(epic);
        SubTask subTask1 = new SubTask("subtask1", "description1", 1, LocalDateTime.of(2023, 11, 6, 1, 1), 1);
        subTask1.setId(2);
        subTask1.setStatus(Status.DONE);
        taskManager.addNewSubTask(subTask1);
        SubTask subTask2 = new SubTask("subtask2", "description2", 1, LocalDateTime.of(2023, 11, 7, 1, 1), 1);
        subTask2.setId(3);
    ...
    public void shouldReturnInProgressWhenSubtasksDoneAndNew(){ // FAIL
        ...
        taskManager.addNewEpicTask(epic);
        SubTask subTask1 = new SubTask("subtask1", "description1", 1, LocalDateTime.of(2023, 11, 9, 1, 1), 1);
        subTask1.setId(2);
        taskManager.addNewSubTask(subTask1);
        subTask1.setStatus(Status.DONE);
        taskManager.updateSubTask(subTask1);
        SubTask subTask2 = new SubTask("subtask2", "description2", 1, LocalDateTime.of(2023, 11, 10, 1, 1), 1);
        subTask2.setId(3);
        taskManager.addNewSubTask(subTask2);
    ...
    public void shouldReturnInProgressWhenAllSubtasksInProgress(){
        ...
        taskManager.addNewEpicTask(epic);
        assertEquals(epic.getStatus(), Status.NEW);
        SubTask subTask1 = new SubTask("subtask1", "description1", 1, LocalDateTime.of(2023, 11, 12, 1, 1), 1);
        subTask1.setId(2);
        subTask1.setStatus(Status.IN_PROGRESS);
        taskManager.addNewSubTask(subTask1);
        SubTask subTask2 = new SubTask("subtask2", "description2", 1, LocalDateTime.of(2023, 11, 13, 1, 1), 1);
        subTask2.setId(3);
